...
package com.factorylabs.orange.core.util
{
	...
	*/
	...
	public final class StringUtil 
	{
		...
		*/
		public static function block(p_string:String, p_len:uint, p_delim:String = "."):Array 
		{
			...
			while (chrIndex <  strLen) {
				...
				subString = subString.replace(new RegExp("[^"+p_delim+"]+$",null), '');
				arr.push(subString);
				chrIndex += subString.length;
			}
			return arr;
		...
		*	@tiptext
		*	
		*	TODO: This isn't working correctly.. check the tests.
		*/
		...
		*	@tiptext
		*	
		*	TODO: This is truncating object pretty weird, check the tests and revisit.
		*/
		 ...
		 * TODO: Allow custom value of decimals to return.
		 */
