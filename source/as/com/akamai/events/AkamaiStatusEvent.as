package com.akamai.events
{
	...
	public class AkamaiStatusEvent extends Event
	{
		 ...
		 */
  		...
  		/**
  		 * The AkamaiStatusEvent.NETSTREAM_XMP_DATA constant defines the value of an AkamaiStatusEvent's
  		 * <code>type</code> property, dispatched when XMP metadata information is found within an FLV file.
  		 */
  			public static const NETSTREAM_XMP_DATA:String = "xmpdata";
		 ...
		 */
            public function AkamaiStatusEvent(type:String, v_info:Object)             {
