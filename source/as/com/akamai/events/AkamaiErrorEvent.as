package com.akamai.events
{
	...
	public class AkamaiErrorEvent extends Event
	{
		 ...
		 */
            public function AkamaiErrorEvent(type:String, v_errorNumber:uint, v_errorDescription:String)             {
                // Call the constructor of the superclass.
                super(type);
                // Set the new properties.
                this.errorNumber = v_errorNumber;
                this.errorDescription = v_errorDescription;
   			}
