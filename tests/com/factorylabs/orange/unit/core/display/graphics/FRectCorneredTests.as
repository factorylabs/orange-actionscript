...
package com.factorylabs.orange.unit.core.display.graphics
{
  ...
  /**
   * Generate the test cases for the FRectCornered class.
   *
   * <hr />
   ...
   *
   * @author    Matthew Kitt
   * @version   1.0.0 :: Dec 27, 2009
   */
  public class FRectCorneredTests
  {
    private var _canvas   :MockCanvas;
    private var _shape    :Shape;
    private var _frect    :FRectCornered;
    ...
    public function runBeforeEachTest() :void
    {
      ...
      _frect = new FRectCornered( _shape.graphics, 0, 0, 500, 100, _magenta, 20, false, false );
      _canvas.add( _shape );
    }
    ...
    {
      assertEquals( _frect.bottomLeft, 20 );
    ...
    {
      assertEquals( _frect.bottomRight, 20 );
    ...
    {
      assertEquals( _frect.corner, 20 );
      _frect.corner = 30;
      assertEquals( _frect.corner, 30 );
      assertEquals( _frect.topLeft, 30 );
      assertEquals( _frect.topRight, 30 );
      assertEquals( _frect.bottomLeft, 30 );
      assertEquals( _frect.bottomRight, 30 );
    }
