...
package com.factorylabs.orange.unit.core.display.graphics
{
  ...
  /**
   * Generate the test cases for the FRectCorneredComplex class.
   *
   * <hr />
   ...
   *
   * @author    Matthew Kitt
   * @version   1.0.0 :: Dec 18, 2009
   */
  public class FRectCorneredComplexTests
  {
    private var _canvas   :MockCanvas;
    private var _shape    :Shape;
    private var _frect    :FRectCorneredComplex;
    ...
    public function runBeforeEachTest() :void
    {
      ...
      _frect = new FRectCorneredComplex( _shape.graphics, 0, 0, 500, 100, _magenta, 20, 20, 10, 10, false, false );
      _canvas.add( _shape );
    }
